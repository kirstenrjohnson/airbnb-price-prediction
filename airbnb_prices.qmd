...
```{python}
# Import data
amsterdam_weekdays = pd.read_csv('/AirbnbPrices/amsterdam_weekdays.csv')
amsterdam_weekends = pd.read_csv('/AirbnbPrices/amsterdam_weekends.csv')
athens_weekdays = pd.read_csv('/AirbnbPrices/athens_weekdays.csv')
athens_weekends = pd.read_csv('/AirbnbPrices/athens_weekends.csv')
barcelona_weekdays = pd.read_csv('/AirbnbPrices/barcelona_weekdays.csv')
barcelona_weekends = pd.read_csv('/AirbnbPrices/barcelona_weekends.csv')
berlin_weekdays = pd.read_csv('/AirbnbPrices/berlin_weekdays.csv')
berlin_weekends = pd.read_csv('/AirbnbPrices/berlin_weekends.csv')
budapest_weekdays = pd.read_csv('/AirbnbPrices/budapest_weekdays.csv')
budapest_weekends = pd.read_csv('/AirbnbPrices/budapest_weekends.csv')
lisbon_weekdays = pd.read_csv('/AirbnbPrices/lisbon_weekdays.csv')
lisbon_weekends = pd.read_csv('/AirbnbPrices/lisbon_weekends.csv')
london_weekdays = pd.read_csv('/AirbnbPrices/london_weekdays.csv')
london_weekends = pd.read_csv('/AirbnbPrices/london_weekends.csv')
paris_weekdays = pd.read_csv('/AirbnbPrices/paris_weekdays.csv')
paris_weekends = pd.read_csv('/AirbnbPrices/paris_weekends.csv')
rome_weekdays = pd.read_csv('/AirbnbPrices/rome_weekdays.csv')
rome_weekends = pd.read_csv('/AirbnbPrices/rome_weekends.csv')
vienna_weekdays = pd.read_csv('/AirbnbPrices/vienna_weekdays.csv')
vienna_weekends = pd.read_csv('/AirbnbPrices/vienna_weekends.csv')
...
```{python}
airbnb_prices.to_csv('/AirbnbPrices/airbnb_prices.csv')
```
...
library(ggthemes)
library(leaflet)
airbnb_locations.gps<-read_csv("/AirbnbPrices/airbnb_prices.csv")
